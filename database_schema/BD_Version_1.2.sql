...
CREATE TABLE IF NOT EXISTS `orders_history` (
  ...
  KEY `FK_orders_history_orders_state` (`id_order_state`),
  CONSTRAINT `FK_orders_history_orders_state` FOREIGN KEY (`id_order_state`) REFERENCES `orders_state` (`id_orders_state`) ON DELETE CASCADE ON UPDATE CASCADE,
